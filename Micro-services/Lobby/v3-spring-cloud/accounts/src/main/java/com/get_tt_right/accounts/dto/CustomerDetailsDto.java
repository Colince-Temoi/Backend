 ...
 * This Dto is going to hold the consolidate data of my customer. As a next step, open the controller package and create a new controller with the name CustomerController.
 * +. Check out this CustomerController for further discussions.
 * */
@Schema(
