 ...
 * Also since we have mentioned this @ConfigurationProperties annotation on top of this class, behind the scenes Spring framework is going to create a bean of this class. That's why we can inject it directly wherever we want to use it using @Autowired annotation. So, I will inject it inside the AccountsController class.
 * */
