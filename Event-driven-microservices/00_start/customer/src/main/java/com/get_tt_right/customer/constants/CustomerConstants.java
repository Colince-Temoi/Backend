package com.get_tt_right.customer.constants;
...
public final class CustomerConstants {
    ...
    public static final String MOBILE_UPD_SUCCESS_MESSAGE = "Mobile Number updation successful in all services"; // This will have the overall saga success message.
    public static final String MOBILE_UPD_FAILURE_MESSAGE = "Mobile Number updation failed in all services"; // This will have the overall saga failure message.
}
