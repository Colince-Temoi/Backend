package com.get_tt_right.accounts.query.controller;
...
/** Here, we are going to have a single query API which is going to read the accounts details based upon the given mobile number by dispatching the FindAccountQuery with the help of QueryGateway.
 * */
@RestController
