...
INSERT INTO `dept3` VALUES (10,'Marketing'),(20,'IT'),(30,'Sales');
...
INSERT INTO `emp1` VALUES (1,'Colince','col@mail.com','IT_PROG','1987-06-21',7500),(3,'Marvin','marv@mail.com','IT_PROG','2019-02-18',20000),(6,'John','john.doe@example.com','IT_PROG','2023-06-17',50000),(7,'Ty','cesar.hyatt@yahoo.com','AD_ASST','2016-03-28',8695.32),(13,'John','john@example.com','DEV','0006-07-15',50000),(14,'Jane','jane@example.com','QA','0006-08-15',60000),(15,'Bob','bob@example.com','PM','0006-09-12',70000),(16,'Praj','praj@example.com','PM','0006-07-05',40000),(17,'Supri','supri@example.com','IT','0006-08-10',30000),(18,'Alice','alice@example.com','SA','0006-09-08',70000),(19,'Jijo','jijo@example.com','SA','0007-02-05',70000),(20,'Jack','tenyi@example.com','IT_PROG','0007-02-05',30000);
...
CREATE TABLE `emp3` (
  ...
  CONSTRAINT `department_id` FOREIGN KEY (`department_id`) REFERENCES `dept3` (`department_id`)
...
CREATE TABLE `t_emp4` (
  ...
  CONSTRAINT `fk_department_id` FOREIGN KEY (`department_id`) REFERENCES `dept3` (`department_id`)
...
INSERT INTO `t_emp4` VALUES (1,'Cloud9',7321,'2024-02-26',10),(2,'Jijo',4321,'2024-02-26',20),(3,'Jan',2792,'2024-03-04',30),(4,'Willi',2356,'2024-03-11',10),(5,'Jr',22856,'2024-03-11',10),(6,'Gong',7856,'2024-02-27',20),(7,'King',5672,'2024-01-29',20);
...
-- Dump completed on 2024-03-09 10:20:29
